...
<DownloadButton 
  href="/spdockit-consultant/downloads/number-of-content-databases-per-web-application.zip"
  filename="number-of-content-databases-per-web-application.zip"
  fileSize="0.8 KB"
  fileType="ZIP"
  description="Custom Best Practices report to count content databases per Web application"
/>
