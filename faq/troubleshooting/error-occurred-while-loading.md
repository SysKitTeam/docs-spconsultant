...
The user running the application needs to have proper privileges to access the information about Site Collections stored in the content databases. [See this article](error-occurred-while-loading.md#internal/requirements/user-permission-requirements) for more details on configuring privileges.
