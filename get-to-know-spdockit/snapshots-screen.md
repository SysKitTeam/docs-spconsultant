...
The **Snapshots Screen** allows SharePoint administrators to track changes made to the SharePoint Farm during its lifetime. The snapshots contain information about all the [settings SPDocKit can retrieve](../../../how-to/create-snapshot.md).
...
* **File Name** – to activate this column go to the **View** tab and use the **Choose Columns** button. For more information on how to change the default file name [see here](../../get-to-know-spdockit/backstage-screen/options-wizard.md#snapshot-options) and observe the snapshots name template section.
